...
suite("PublicClient", () => {
  ...
  const client = new index_js_1.PublicClient();
  ...
  test(".constructor() (with custom parameters)", () => {
    ...
    const otherClient = new index_js_1.PublicClient({ symbol });
    (0, node_assert_1.deepStrictEqual)(otherClient.symbol, symbol);
  });
  test(".getMarkets()", async () => {
    ...
    const path = "markets";
    const url = new URL(path, index_js_1.ApiUrl);
    mockPool
      .intercept({ path: url.pathname, method: "GET" })
      .reply(200, markets);
    const data = await client.getMarkets();
    (0, node_assert_1.deepStrictEqual)(data, markets);
  });
  test(".getMarket()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, market);
  });
  test(".getMarket() (with no `symbol`)", async () => {
    ...
    const symbol = index_js_1.DefaultSymbol;
    const path = `markets/${symbol}`;
    const url = new URL(path, index_js_1.ApiUrl);
    mockPool
      .intercept({ path: url.pathname, method: "GET" })
  ...
  test(".getCurrency()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, {
      ...response[currency],
      currency,
    });
  });
  ...
  test(".getPrices()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, prices);
  });
  test(".getPrice()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, price);
  });
  ...
  test(".getOrderBook()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, book);
  });
  ...
  test(".getCandles()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, candles);
  });
  ...
  test(".getTickers()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, tickers);
  });
  ...
  test(".getBorrowRates()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, rates);
  });
});
