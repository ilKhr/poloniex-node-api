...
suite("PublicClient", () => {
  ...
  test(".constructor() (with custom parameters)", () => {
    ...
    const otherClient = new index_js_1.PublicClient({ currencyPair });
  ...
  test(".get() (throws an error)", async () => {
    ...
    mockPool
      ...
      .reply(200, { error });
    await (0, node_assert_1.rejects)(client.get(path), new Error(error));
  });
  ...
  test(".getOrderBook()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, books);
  });
  ...
  test(".getOrderBook() (with no `depth`)", async () => {
    ...
    const depth = index_js_1.ApiLimit;
    const query = { command, currencyPair, depth };
    mockPool
      .intercept({ path: url.pathname, method: "GET", query })
      .reply(200, book);
  ...
  test(".getCurrencies()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, currencies);
  });
  ...
  test(".getLoanOrders()", async () => {
    ...
    (0, node_assert_1.deepStrictEqual)(data, loans);
  });
});
